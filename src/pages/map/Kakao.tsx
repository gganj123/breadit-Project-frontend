...
import rightAngle from '/right-arrow.svg';
import reSearch from '/arrow-rotate.svg';
...
const KEYWORD_LIST = [
  { id: 1, value: '케이크', emoji: '☕️' },
  { id: 2, value: '빵', emoji: '☕️' },
  { id: 3, value: '구움과자', emoji: '☕️' },
  { id: 4, value: '샌드위치', emoji: '☕️' },
];
...
const Kakao = () => {
  ...
  const [keyword, setKeyword] = useState('빵집');
  // 검색 결과를 담는 상태 변수
      ...
      <S.MapContainer>
        ...
        <S.ListContainer isClosed={!isSidebarOpen}>
          <Modal
            ...
            pagination={pagination} // pagination prop 추가
            currentPage={currentPage}
            setCurrentPage={setCurrentPage}
            isModalOpen={isSidebarOpen} // isModalOpen prop 추가
          />
          {/* 사이드바 열고 다는 버튼 */}
          <S.SideBarOpenBtn
          ...
          >
            <img
              src={isSidebarOpen ? rightAngle : rightAngle}
